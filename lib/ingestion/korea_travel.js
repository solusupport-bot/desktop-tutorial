...
const SOURCES = [
  ...
  // 2026-09-11 사용자 요청("매일 블로그 글이 중복없이 올라가도록") — sync-blog-posts.js는
  // 아직 블로그 글이 없는 주제를 발견하면 자동으로 새 글을 쓰지만, 23개 기존 주제가
  // 전부 이미 글을 갖고 있어서 새 글이 안 나오고 있었다. 여기 새 주제를 추가하면
  // (scripts/sync-blog-posts.js의 하루 1건 제한과 함께) 매일 새 블로그 글이 하나씩
  // 나가는 재고 역할을 한다. 재고가 줄어들면(REMAINING_BLOG_TOPICS_WARNING 참고)
  // 다음 세션에서 같은 방식으로 더 추가할 것 — 무한 자동 발굴 파이프라인은 아직 없음.
  {
    topic: 'Insadong traditional culture street',
    author: 'Land in Korea Desk',
    url: 'https://english.visitkorea.or.kr',
    category: 'attraction',
    placeKeyword: '인사동',
  ...
  {
    topic: 'Everland vs. Lotte World theme parks',
    author: 'Land in Korea Desk',
  ...
  {
    topic: 'Hongdae nightlife and youth culture district',
    author: 'Land in Korea Desk',
    url: 'https://english.visitkorea.or.kr',
    category: 'attraction',
    placeKeyword: '홍대',
    content: [
      "Hongdae (named for Hongik University) runs on a schedule most visitors don't expect — it's quiet in the afternoon and doesn't really start until evening, especially on weekends. It's Seoul's center for indie music clubs, streetwear shops, and youth fashion, with live busking performances clustering around 'Hongdae Playground' park on weekend evenings. Club and bar streets stay open late, well past when most other Seoul neighborhoods wind down.",
      "The street performances everyone posts about aren't a fixed schedule — they cluster on weekend evenings and thin out on weeknights, so a Tuesday visit expecting the same energy as a Saturday post will disappoint. Small independent clothing boutiques and vintage shops fill the side streets more than the main road. It's also one of the more walkable nightlife districts, with clubs, bars, and late-night food stalls within a few blocks of each other rather than spread across the city."
    ]
  },
  {
    topic: 'Nami Island and Petite France day trip',
    author: 'Land in Korea Desk',
    url: 'https://www.visitkorea.or.kr',
    category: 'attraction',
    placeKeyword: '남이섬',
    content: [
      "Nami Island isn't actually reachable by a bridge you can just walk across — it's a half-moon-shaped island in Gapyeong reached only by a short ferry ride (or a zipline for the adventurous), which surprises visitors expecting a normal park entrance. The island's tree-lined paths, especially the ginkgo and metasequoia lanes, made it a filming location for the drama 'Winter Sonata' and remain the main draw. Petite France, a French-village-themed attraction with colorful buildings, sits nearby and is commonly paired with Nami Island in the same day-trip package.",
  ...
  {
    topic: 'Suwon Hwaseong Fortress',
    author: 'Land in Korea Desk',
    url: 'https://english.visitkorea.or.kr',
    category: 'attraction',
    placeKeyword: '수원화성',
    content: [
      "Hwaseong Fortress isn't a ruin you view from outside — it's a UNESCO World Heritage fortress wall you actually walk along, built in 1796 and still encircling much of old Suwon city. The full wall walk covers several kilometers with gates, command posts, and watchtowers along the way, and most visitors underestimate how long the full loop takes. Hwaseong Haenggung, a temporary palace within the fortress grounds, hosts historical reenactment ceremonies on select days worth checking before you go.",
      "Suwon sits close enough to Seoul (about 30-40 minutes by intercity train, or accessible via subway line 1) that it works as a half-day trip without an overnight stay. Most tourists only walk a short section near the entrance and miss that the fortress wraps around the whole old town — renting a bike or taking the local tour tram covers more ground than walking the entire loop on foot. The view from the higher command posts over Suwon's old town is one of the most underrated skyline views near Seoul."
    ]
  },
  {
    topic: 'Domestic flights vs. KTX for Jeju and long-distance trips',
    author: 'Land in Korea Desk',
    url: 'https://www.airport.kr',
    content: [
      ...
      "Booking a domestic flight to Jeju without comparing total door-to-door time against KTX-plus-onward-transit for mainland trips is the most common miscalculation first-timers make. Domestic terminals at Gimpo and Gimhae (Busan) are separate from the international terminals, so don't assume international arrival/departure procedures apply — domestic flights use lighter security and no passport control. Peak holiday periods sell out both flights and KTX seats fast, so book mainland long-distance and Jeju flights well ahead during Korean public holidays."
    ]
  },
  {
    topic: 'Seoul attraction pass comparison',
    author: 'Land in Korea Desk',
    url: 'https://www.visitseoul.net',
    content: [
      ...
      "The math that actually decides if a pass is worth it: add up the individual entry prices for everything you'd actually visit that day, then compare against the pass price — most people skip this step and just assume bundling is automatically cheaper. Passes work best on days packed with paid palace/museum/tower visits back to back, and worst on days mixing in a lot of free attractions (parks, markets, walking neighborhoods) that don't need a pass at all."
    ]
  },
  {
    topic: 'Korean public holidays that disrupt travel plans',
    author: 'Land in Korea Desk',
    url: 'https://english.visitkorea.or.kr',
    content: [
      ...
      "Many small restaurants, markets, and family-run shops close for several consecutive days around Chuseok and Seollal, while large attractions, chain stores, and hotels generally stay open — so a itinerary built around market food stalls can fall apart during these windows. If travel dates land near either holiday, book intercity trains and any domestic flights as early as possible, and have backup restaurant options in mind since neighborhood favorites may simply be shuttered."
    ]
  }
];
