...
<header class="site-header">
  <a class="brand" href="/index.html">{html.escape(cfg['site_name'])}</a>
...
<footer class="site-footer">
  ...
  <p><a href="/about.html">소개</a> · <a href="/privacy.html">개인정보처리방침</a> · <a href="/contact.html">문의</a></p>
</footer>
</body>
</html>
"""
...
def build():
    ...
    for p in posts:
        article = (
            ...
            f'{p["_body_html"]}'
            f'</article>'
            f'<p class="back"><a href="/index.html">← 목록으로</a></p>'
        )
...
<h2>운영자</h2>
<p>{html.escape(cfg['author'])} · 문의: <a href="/contact.html">문의 페이지</a></p>
"""
    privacy = f"""
<h1>개인정보처리방침</h1>
