...
def page(cfg, title, description, body, canonical, is_post=False):
    ...
    nav = (
        ...
        '<a href="/desktop-tutorial/land-in-korea-blog/site/affiliate-disclosure.html">Disclosure</a>'
        '<a href="/desktop-tutorial/land-in-korea-blog/site/contact.html">Contact</a>'
    )
...
<footer class="site-footer">
  ...
  we may earn a commission at no extra cost to you. See our <a href="/desktop-tutorial/land-in-korea-blog/site/affiliate-disclosure.html">disclosure</a>.
  Prices and rules change — always confirm on the official site before booking.</p>
  <p><a href="/desktop-tutorial/land-in-korea-blog/site/about.html">About</a> ·
  <a href="/desktop-tutorial/land-in-korea-blog/site/affiliate-disclosure.html">Disclosure</a> ·
  <a href="/desktop-tutorial/land-in-korea-blog/site/contact.html">Contact</a></p>
</footer>
</body>
</html>
"""
...
<a href="/desktop-tutorial/land-in-korea-blog/site/affiliate-disclosure.html">disclosure</a>.</li>
<li>Prices, thresholds, and rules change — always confirm on the official site before you book or travel.</li>
</ul>
<p>Contact: <a href="/desktop-tutorial/land-in-korea-blog/site/contact.html">contact page</a></p>
"""
    disclosure = f"""
...
<a href="/desktop-tutorial/land-in-korea-blog/site/contact.html">contact page</a>.</p>
"""
    privacy = f"""
